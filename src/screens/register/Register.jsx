...
const Register = () => {
  ...
  return (
    <Box  sx={{height: '80vh'}} className='d-flex justify-content-center align-item-center'>
      <form onSubmit={Register} className='d-flex justify-content-center flex-column align-item-center w-25 gap-5'>
        ...
        <Button type='submit' variant="contained">{loading ? <CircularProgress sx={{color: ' white'}} size={25}/>: "Register" }</Button>
      </form>
